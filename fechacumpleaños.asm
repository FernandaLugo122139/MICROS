...
nop ;NOPs de relleno (ajuste de tiempo) 1
nop 
nop
...
;rutina de tiempo
tiempo:
movlw d'86' ;establecer valor de la variable m 3
movwf m
mloop:
decfsz m,f
goto mloop
...
movwf i
iloop:
nop ;NOPs de relleno (ajuste de tiempo) 120
nop
   
movlw d'20' ;establecer valor de la variable j 
movwf j
jloop:
nop
nop
